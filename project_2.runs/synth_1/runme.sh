...
HD_PWD='/home/antonina/Desktop/fpga_hiwi/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_sim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pid_sim.tcl
